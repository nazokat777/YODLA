...
export function buttonStyles(options: {
  ...
  return cn(
    'tap-highlight-none inline-flex items-center justify-center gap-2 rounded-2xl font-bold tracking-wide',
    'transition-all duration-100 active:translate-y-[2px] active:shadow-none active:border-b-2',
